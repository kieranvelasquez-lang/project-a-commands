...
First, load staged corrections: read `~/.claude/project-a/memory/morning-recap-corrections.md`. Any company listed there overrides default routing.
...
Post the unified message to channel ID `YOUR_AUTOMATION_TESTS_CHANNEL_ID` using `slack_send_message`.
...
2. Append to `~/.claude/project-a/memory/morning-recap-corrections.md`:
```
